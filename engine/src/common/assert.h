...
#include "logger.h"
	...
	#define ASSERT_LOG(...) prev::Logger::ChangeColor(prev::LoggerColor::COLOR_RED); prev::Logger::Log(__VA_ARGS__); prev::Logger::ChangeColor(prev::LoggerColor::COLOR_ORIGINAL)
#else
	#define ASSERT_LOG(...)
#endif
